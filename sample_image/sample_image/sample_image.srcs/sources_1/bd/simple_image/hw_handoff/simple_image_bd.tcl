...
################################################################
# This is a generated script based on design: simple_image
#
...
# source simple_image_script.tcl
...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set o_pixel_data [ create_bd_port -dir O -from 8 -to 0 o_pixel_data ]
  set o_pwm_data [ create_bd_port -dir O o_pwm_data ]
  ...
  # Create instance: pixel_mb_mem_0, and set properties
  set block_name pixel_mb_mem
  set block_cell_name pixel_mb_mem_0
  if { [catch {set pixel_mb_mem_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $pixel_mb_mem_0 eq "" } {
 ...
 ] [get_bd_intf_pins /pixel_mb_mem_0/S_AXI]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins pixel_mb_mem_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net pixel_mb_mem_0_o_pixel_data [get_bd_ports o_pixel_data] [get_bd_pins pixel_mb_mem_0/o_pixel_data]
  connect_bd_net -net pixel_mb_mem_0_o_pwm_data [get_bd_ports o_pwm_data] [get_bd_pins pixel_mb_mem_0/o_pwm_data]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins pixel_mb_mem_0/S_AXI_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins pixel_mb_mem_0/i_pixel_clk] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_50M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins pixel_mb_mem_0/S_AXI_ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x41200000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] SEG_axi_gpio_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pixel_mb_mem_0/S_AXI/reg0] SEG_pixel_mb_mem_0_reg0
