...
##Pmod Header JC
## jc0 is mirror frame output
## jc1 is mirror output
## jc2 is supply 1 pwm output (140V supply)
## jc3 is supply 2 pwm output (70V supply)
## ps_en is on/off for board
## supply1_fb is comparator for supply 1
## supply2_fb is comparator for supply 2
set_property -dict {PACKAGE_PIN V15 IOSTANDARD LVCMOS33} [get_ports jc0]
set_property -dict {PACKAGE_PIN W15 IOSTANDARD LVCMOS33} [get_ports jc1]
set_property -dict {PACKAGE_PIN T11 IOSTANDARD LVCMOS33} [get_ports jc2]
set_property -dict {PACKAGE_PIN T10 IOSTANDARD LVCMOS33} [get_ports jc3]
set_property -dict {PACKAGE_PIN Y14 IOSTANDARD LVCMOS33} [get_ports ps_en]
set_property -dict {PACKAGE_PIN T12 IOSTANDARD LVCMOS33} [get_ports supply1_fb]
set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS33} [get_ports supply2_fb]
...
##Pmod Header JD
set_property -dict {PACKAGE_PIN T15 IOSTANDARD LVCMOS33} [get_ports jd1_n]
set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS33} [get_ports jd1_p]
#set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVDS     } [get_ports { jd_n[1] }]; #IO_L5N_T0_34 Sch=jd_n[1]
...
set_property -dict {PACKAGE_PIN R14 IOSTANDARD LVCMOS33} [get_ports pwr_en]
#set_property -dict { PACKAGE_PIN P14   IOSTANDARD LVDS     } [get_ports { jd_p[2] }]; #IO_L6P_T0_34 Sch=jd_p[2]
set_property -dict {PACKAGE_PIN U15 IOSTANDARD LVCMOS33} [get_ports laser_iic_scl_io]
#set_property -dict { PACKAGE_PIN U15   IOSTANDARD LVDS     } [get_ports { jd_n[3] }]; #IO_L11N_T1_SRCC_34 Sch=jd_n[3]
set_property -dict {PACKAGE_PIN U14 IOSTANDARD LVCMOS33} [get_ports dis]
...
set_property -dict {PACKAGE_PIN V18 IOSTANDARD LVCMOS33} [get_ports flt]
set_property -dict {PACKAGE_PIN V17 IOSTANDARD LVCMOS33} [get_ports laser_iic_sda_io]
