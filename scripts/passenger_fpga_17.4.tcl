...
#
# passenger_fpga_17.4.tcl: Tcl script for re-creating project 'cam_pwm_fpga'
#
# Generated by Vivado on Tue Feb 09 20:16:53 CST 2021
...
#
# 1. This project restoration tcl script (passenger_fpga_17.4.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/am_users/dmorelli/passenger/projects/passenger_fpga/image_pwm_proc_orig/cam_pwm_fpga.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v"
#
# 3. The following remote source files that were added to the original project:-
#
#    "/am_users/dmorelli/passenger/projects/passenger_fpga/ZyboZ7_A.xdc"
#
#*****************************************************************************************
...
set script_file "passenger_fpga_17.4.tcl"
...
#set orig_proj_dir "[file normalize "$origin_dir/image_pwm_proc_orig"]"
...
set files [list \
 "[file normalize "$origin_dir/src_files/design_1_wrapper.v"]"\
]
...
set file "[file normalize "$origin_dir/src_files/ZyboZ7_A.xdc"]"
set file_added [add_files -norecurse -fileset $obj $file]
set file "$origin_dir/src_files/ZyboZ7_A.xdc"
...
proc cr_bd_design_1 { parentCell } {
  ...
  xilinx.com:user:mirror_driver_v1_1:1.1\
...
if {[string equal [get_runs -quiet impl_2] ""]} {
    create_run -name impl_2 -part xc7z020clg400-1 -flow {Vivado Implementation 2016} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_2
} else {
