...
# <./image_pwm_proc/cam_pwm_fpga.xpr> in the current working folder.

set list_projs [get_projects -quiet]
if { $list_projs eq "" } {
   create_project cam_pwm_fpga image_pwm_proc -part xc7z010clg400-1
...
proc create_root_design { parentCell } {
  ...
  set laser_iic [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:iic_rtl:1.0 laser_iic ]
  set leds_4bits [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 leds_4bits ]
  set rgb_led [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 rgb_led ]

  # Create ports
  set dis [ create_bd_port -dir O -from 0 -to 0 dis ]
  set flt [ create_bd_port -dir I -type intr flt ]
  set jc0 [ create_bd_port -dir O -from 0 -to 0 jc0 ]
  set jc1 [ create_bd_port -dir O -from 0 -to 0 jc1 ]
  set jc2 [ create_bd_port -dir O -from 0 -to 0 -type data jc2 ]
  set jc3 [ create_bd_port -dir O -from 0 -to 0 -type data jc3 ]
  set jd1_n [ create_bd_port -dir O -from 0 -to 0 jd1_n ]
  set jd1_p [ create_bd_port -dir O -from 0 -to 0 jd1_p ]
  set ps_en [ create_bd_port -dir O -from 0 -to 0 ps_en ]
  set pwr_en [ create_bd_port -dir O -from 0 -to 0 pwr_en ]
  set supply1_fb [ create_bd_port -dir I supply1_fb ]
  set supply2_fb [ create_bd_port -dir I supply2_fb ]
...
CONFIG.Output_Width {8} \
  ...
  # Create instance: mirror_driver_v1_1_0, and set properties
  set mirror_driver_v1_1_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:mirror_driver_v1_1:1.1 mirror_driver_v1_1_0 ]

  # Create instance: mirror_driver_v1_1_1, and set properties
  set mirror_driver_v1_1_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:mirror_driver_v1_1:1.1 mirror_driver_v1_1_1 ]
...
CONFIG.DOUT_WIDTH {1} \
  ...
  connect_bd_intf_net -intf_net axi_iic_0_IIC [get_bd_intf_ports laser_iic] [get_bd_intf_pins axi_iic_0/IIC]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins PWM_0/PWM_AXI] [get_bd_intf_pins ps7_0_axi_periph/M02_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins PWM_1/PWM_AXI] [get_bd_intf_pins ps7_0_axi_periph/M03_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M04_AXI [get_bd_intf_pins mirror_driver_v1_1_0/s00_axi] [get_bd_intf_pins ps7_0_axi_periph/M04_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M05_AXI [get_bd_intf_pins mirror_driver_v1_1_1/s00_axi] [get_bd_intf_pins ps7_0_axi_periph/M05_AXI]
  ...
  connect_bd_net -net PWM_0_pwm [get_bd_pins PWM_0/pwm] [get_bd_pins util_vector_logic_2/Op1]
  connect_bd_net -net PWM_1_pwm [get_bd_pins PWM_1/pwm] [get_bd_pins util_vector_logic_4/Op1]
  connect_bd_net -net axi_iic_0_gpo [get_bd_pins axi_iic_0/gpo] [get_bd_pins xlslice_1/Din] [get_bd_pins xlslice_2/Din] [get_bd_pins xlslice_3/Din]
  ...
  connect_bd_net -net flt_1 [get_bd_ports flt] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net mirror_driver_v1_1_0_mirror [get_bd_ports jc1] [get_bd_pins mirror_driver_v1_1_0/mirror]
  connect_bd_net -net mirror_driver_v1_1_1_mirror [get_bd_ports jc0] [get_bd_pins mirror_driver_v1_1_1/mirror]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins PWM_0/pwm_axi_aclk] [get_bd_pins PWM_1/pwm_axi_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins mirror_driver_v1_1_0/s00_axi_aclk] [get_bd_pins mirror_driver_v1_1_1/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/M04_ACLK] [get_bd_pins ps7_0_axi_periph/M05_ACLK] [get_bd_pins ps7_0_axi_periph/M06_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_50M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins PWM_0/pwm_axi_aresetn] [get_bd_pins PWM_1/pwm_axi_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins mirror_driver_v1_1_0/s00_axi_aresetn] [get_bd_pins mirror_driver_v1_1_1/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/M04_ARESETN] [get_bd_pins ps7_0_axi_periph/M05_ARESETN] [get_bd_pins ps7_0_axi_periph/M06_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  connect_bd_net -net supply1_fb_1 [get_bd_ports supply1_fb] [get_bd_pins util_vector_logic_3/Op1]
  connect_bd_net -net supply2_fb_1 [get_bd_ports supply2_fb] [get_bd_pins util_vector_logic_5/Op1]
  connect_bd_net -net sw_1 [get_bd_ports sw] [get_bd_pins xlconcat_0/In0]
  connect_bd_net -net util_vector_logic_0_Res [get_bd_ports jd1_n] [get_bd_pins util_vector_logic_0/Res]
  connect_bd_net -net util_vector_logic_1_Res [get_bd_ports jd1_p] [get_bd_pins util_vector_logic_1/Res]
  connect_bd_net -net util_vector_logic_2_Res [get_bd_ports jc2] [get_bd_pins util_vector_logic_2/Res]
  connect_bd_net -net util_vector_logic_3_Res [get_bd_pins util_vector_logic_2/Op2] [get_bd_pins util_vector_logic_3/Res]
  connect_bd_net -net util_vector_logic_4_Res [get_bd_ports jc3] [get_bd_pins util_vector_logic_4/Res]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_pins util_vector_logic_0/Op1] [get_bd_pins util_vector_logic_1/Op2] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_ports dis] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_ports pwr_en] [get_bd_pins xlslice_2/Dout]
  connect_bd_net -net xlslice_3_Dout [get_bd_ports ps_en] [get_bd_pins xlslice_3/Dout]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mirror_driver_v1_1_0/s00_axi/reg0] SEG_mirror_driver_v1_1_0_reg0
  create_bd_addr_seg -range 0x00010000 -offset 0x43C30000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mirror_driver_v1_1_1/s00_axi/reg0] SEG_mirror_driver_v1_1_1_reg0
...
preplace port btns_4bits -pg 1 -y 50 -defaultsOSRD
preplace port supply1_fb -pg 1 -y 1100 -defaultsOSRD -right
preplace port flt -pg 1 -y 1470 -defaultsOSRD -right
preplace port laser_iic -pg 1 -y 310 -defaultsOSRD
preplace port leds_4bits -pg 1 -y 70 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 280 -defaultsOSRD
preplace port rgb_led -pg 1 -y 1030 -defaultsOSRD
preplace port supply2_fb -pg 1 -y 1320 -defaultsOSRD -right
preplace portBus ps_en -pg 1 -y 590 -defaultsOSRD
preplace portBus jc0 -pg 1 -y 670 -defaultsOSRD
preplace portBus sw -pg 1 -y 1440 -defaultsOSRD -right
preplace portBus dis -pg 1 -y 430 -defaultsOSRD
preplace portBus jc1 -pg 1 -y 160 -defaultsOSRD
preplace portBus jc2 -pg 1 -y 1170 -defaultsOSRD
preplace portBus jd1_n -pg 1 -y 1620 -defaultsOSRD
preplace portBus jc3 -pg 1 -y 1270 -defaultsOSRD
preplace portBus jd1_p -pg 1 -y 1530 -defaultsOSRD
preplace portBus pwr_en -pg 1 -y 510 -defaultsOSRD
preplace inst rst_ps7_0_50M -pg 1 -lvl 1 -y 160 -defaultsOSRD
preplace inst xlslice_0 -pg 1 -lvl 3 -y 1600 -defaultsOSRD
preplace inst axi_iic_0 -pg 1 -lvl 4 -y 330 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 3 -y 1520 -defaultsOSRD
preplace inst xlslice_1 -pg 1 -lvl 4 -y 430 -defaultsOSRD
preplace inst xlslice_2 -pg 1 -lvl 4 -y 510 -defaultsOSRD
preplace inst xlslice_3 -pg 1 -lvl 4 -y 590 -defaultsOSRD
preplace inst xlconcat_0 -pg 1 -lvl 4 -y 1380 -defaultsOSRD
preplace inst util_vector_logic_0 -pg 1 -lvl 4 -y 1620 -defaultsOSRD
preplace inst axi_gpio_0 -pg 1 -lvl 4 -y 60 -defaultsOSRD
preplace inst mirror_driver_v1_1_0 -pg 1 -lvl 4 -y 180 -defaultsOSRD
preplace inst util_vector_logic_1 -pg 1 -lvl 4 -y 1530 -defaultsOSRD
preplace inst c_counter_binary_0 -pg 1 -lvl 2 -y 1600 -defaultsOSRD
preplace inst axi_gpio_1 -pg 1 -lvl 4 -y 1050 -defaultsOSRD
preplace inst util_vector_logic_2 -pg 1 -lvl 4 -y 1170 -defaultsOSRD
preplace inst mirror_driver_v1_1_1 -pg 1 -lvl 4 -y 690 -defaultsOSRD
preplace inst PWM_0 -pg 1 -lvl 4 -y 810 -defaultsOSRD
preplace inst util_vector_logic_3 -pg 1 -lvl 3 -y 1180 -defaultsOSRD
preplace inst PWM_1 -pg 1 -lvl 4 -y 930 -defaultsOSRD
preplace inst util_vector_logic_4 -pg 1 -lvl 4 -y 1270 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 3 -y 520 -defaultsOSRD
preplace inst util_vector_logic_5 -pg 1 -lvl 3 -y 1280 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 2 -y 320 -defaultsOSRD
preplace netloc processing_system7_0_DDR 1 2 3 NJ 260 NJ 260 NJ
preplace netloc ps7_0_axi_periph_M02_AXI 1 3 1 1110
preplace netloc supply2_fb_1 1 2 3 780 1460 NJ 1460 1450J
preplace netloc xlslice_3_Dout 1 4 1 N
preplace netloc PWM_0_pwm 1 3 2 1110 1440 1430
preplace netloc flt_1 1 3 2 1150 1670 1470J
preplace netloc xlslice_1_Dout 1 4 1 NJ
preplace netloc axi_iic_0_iic2intc_irpt 1 1 4 350 -20 NJ -20 NJ -20 1420
preplace netloc processing_system7_0_M_AXI_GP0 1 2 1 770
preplace netloc util_vector_logic_4_Res 1 4 1 NJ
preplace netloc util_vector_logic_3_Res 1 3 1 NJ
preplace netloc mirror_driver_v1_1_1_mirror 1 4 1 NJ
preplace netloc util_vector_logic_0_Res 1 4 1 NJ
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 3 -10 70 NJ 70 750
preplace netloc ps7_0_axi_periph_M03_AXI 1 3 1 1080
preplace netloc ps7_0_axi_periph_M01_AXI 1 3 1 1100
preplace netloc rst_ps7_0_50M_interconnect_aresetn 1 1 2 NJ 180 780
preplace netloc supply1_fb_1 1 2 3 750 1450 NJ 1450 1440J
...
preplace netloc processing_system7_0_FIXED_IO 1 2 3 NJ 280 1080J 250 1430J
preplace netloc axi_gpio_0_GPIO2 1 4 1 NJ
preplace netloc ps7_0_axi_periph_M06_AXI 1 3 1 1140
preplace netloc xlslice_2_Dout 1 4 1 NJ
preplace netloc rst_ps7_0_50M_peripheral_aresetn 1 1 3 NJ 200 790 200 1130
preplace netloc axi_iic_0_IIC 1 4 1 NJ
preplace netloc axi_gpio_0_GPIO 1 4 1 NJ
preplace netloc mirror_driver_v1_1_0_mirror 1 4 1 NJ
preplace netloc axi_iic_0_gpo 1 3 2 1150 -10 1410
preplace netloc ps7_0_axi_periph_M05_AXI 1 3 1 1090
preplace netloc ps7_0_axi_periph_M04_AXI 1 3 1 1090
preplace netloc util_vector_logic_2_Res 1 4 1 NJ
preplace netloc sw_1 1 3 2 1090 1680 1460J
preplace netloc util_vector_logic_1_Res 1 4 1 NJ
preplace netloc processing_system7_0_FCLK_CLK0 1 0 4 0 810 340 810 760 810 1120
preplace netloc axi_gpio_1_GPIO 1 4 1 NJ
preplace netloc ps7_0_axi_periph_M00_AXI 1 3 1 1070
preplace netloc util_vector_logic_5_Res 1 3 1 NJ
preplace netloc processing_system7_0_FCLK_CLK1 1 1 2 360 210 740
preplace netloc PWM_1_pwm 1 3 2 1130 1470 1420
preplace netloc xlslice_0_Dout 1 3 1 1070
levelinfo -pg 1 -30 170 550 930 1280 1490 -top -30 -bot 1690
",
}
